// src/modules/institute/dto/index.dto.ts
export { CreateInstituteDto } from './create-institute.dto';
...
export { InstituteSettingsResponseDto, InstituteProfileResponseDto } from './institute-settings.dto';
export { InstituteQueryDto } from './institute-query.dto';
export { 
  PaginatedInstituteResponseDto, 
  PaginationMetaDto 
} from './paginated-institute-response.dto';
